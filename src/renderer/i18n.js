...
window.I18n = (function () {
  const TRANSLATIONS = {
    fr: {
      ...
      'login.renameThisProfile': 'Modifier ce profil',
      ...
      'modal.renameTitle': 'Modifier ce profil',
      'modal.renameSubtitle': 'Modifiez le nom et l\'image de ce profil',
      'modal.renamePlaceholder': 'Nouveau nom',
      'modal.changeImage': 'Importer une image',
      'modal.removeImage': 'Retirer l\'image',
    ...
    en: {
      ...
      'login.renameThisProfile': 'Edit this profile',
      ...
      'modal.renameTitle': 'Edit profile',
      'modal.renameSubtitle': 'Edit this profile\'s name and image',
      'modal.renamePlaceholder': 'New name',
      'modal.changeImage': 'Import an image',
