...
let manualSetupModal, manualSetupKeyInput, manualTunnelIpInput, manualSetupError, manualSetupConfirmBtn, manualSetupCancelBtn;
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  manualTunnelIpInput = document.getElementById('manual-tunnel-ip-input');
